...
<main>
    ...
    <div class="wiki">
        ...
        <div class="section lang">
            <h3>Set the language for a page:</h3>
            <p>
                Add the "lang" search parameter along with your request. So to get the profile of "@username", with the language "es" ( spanish ) you'd have to go to:
            </p>
            <code>
                https://prns.realfx.rocks/@username?lang=es
            </code>
        </div>
    </div>
</main>
